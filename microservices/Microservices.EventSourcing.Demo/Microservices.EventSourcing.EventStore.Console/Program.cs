...
await eventStoreService.SubscribeToStreamAynsc(
    streamName: $"customer-{accountCreatedEvent.CustomerId}-stream",
    async (ss, re, ct) =>
    {
...
class EventStoreService
{
    ...
    private EventStoreClient Client => new EventStoreClient(GetEventStoreClientSettings());
    ...
    public async Task SubscribeToStreamAynsc(
        string streamName,
